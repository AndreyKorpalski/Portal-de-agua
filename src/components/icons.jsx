export function DropletIcon({ size = 24, stroke = 'currentColor', strokeWidth = 1.6 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth={strokeWidth}>
      <path d="M12 2.5c-4 5-6.5 8.7-6.5 12A6.5 6.5 0 0 0 12 21a6.5 6.5 0 0 0 6.5-6.5c0-3.3-2.5-7-6.5-12Z" />
    </svg>
  );
}
...
export function AssociadosIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function AdministradoresIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function RelatoriosIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M15 3.5V8h4" />
      <path d="M8.5 13v4M12 11v6M15.5 14.5v3.5" />
    </svg>
  );
}
